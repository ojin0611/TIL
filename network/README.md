...
캐싱은 주어진 리소스의 복사본을 저장하고 있다가 요청 시에 그것을 제공하는 기술이다. 캐싱을 이용해 클라이언트 요청에 빠르게 응답할 수 있다.

![img](images/997EBF395C4C09162B) 

[그림 출처](https://goddaehee.tistory.com/171?category=281064)



캐시의 종류는 여러 가지 있다. 사설 브라우저 캐시, 공유 프록시 캐시, 웹 캐시, 게이트웨이 캐시 등이 있다. 